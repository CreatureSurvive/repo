...
!function(e){"use strict";if(e.documentElement.classList.contains("cydia")){var n=e.createElement("base");n.target="_open",e.head.appendChild(n)}}(document),window.onload=function(){if(document.documentElement.classList.contains("cydia"))for(var e=document.getElementsByClassName("cydia_blank"),n=0;n<e.length;n++)e[n].target="_blank"};